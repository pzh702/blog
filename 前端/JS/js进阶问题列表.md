...
关注题目：1、8、11、12、13、14、18、19、22、29、32、34、37、38、40、44、46、48、50、51、57、58、59、63、64、67、68、71、73、78、82、83、92、94、97、99、106、111、112、114、116、119(答案有误)、122、127(解构赋值不一样)、133(异步和事件的调用)、141、144、152、154、
...
//块级作用域里面可以重新定义外面的变量：当都为 let、var 或者未定义时时，两者为同一个变量；不一样时为两个不同的变量。
